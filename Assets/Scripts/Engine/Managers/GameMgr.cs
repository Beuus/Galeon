...
public class GameMgr 
{
    ...
    private GameMgr()
	{
        ...
        if (m_servers == null)
		{
            //Si no existe el lo creamos el server al buelo
            ...
            //TODO (InputMgr)
            //Destruyo el anterior y pongo el nuevo
            AddServer<SceneMgr>();
    ...
    //Añadir componentes con cualquier sitio
	...
	protected void ProcessBaseConfiguration()
	{
        ...
        //Guardar partidas o congiguración, guardamos lo que pone en la configuración
