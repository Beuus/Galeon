...
//Opcion de creacion para que aparezca en Create -> [CreateAssetMenu(fileName = "BaseConfig", menuName = "Create GameMgrConfig")] es como un inspecter y configurariamos los manager
